...
class ProjectForm extends Component {
    ...
    constructor (props) {
        ...
        if (props.project){
            ...
            sd = props.project.getShort_Description();
        ...
        this.State ={
            ...
            Short_DescriptionValidationFailed:false, 
            Short_DescriptionEdited: false,
    ...
    addProject = () => {
        let newProject = new ProjectNBO (this.state.name, this.state.Short_Description,this.state.External_Partners,this.state.capacity,
    ...
    updateProject = () => {
        ...
        let updatedProject = Object.assign(newProjectNBO(),this.props.project);
        //set the new attributes über den Dialog
        
        updatedProject.setName();
        updatedProject.setShort_Description();
        ...
        ProjectAdminAPI.getAPI().updateProject(updatedProject).then(project => {
            ...
            this.baseState.Short_Description = this.state.Short_Description;
    ...
    render() {
        ...
        const { name, nameValidationFailed, nameEdited, Short_Description, Short_DescriptionValidationFailed, Short_DescriptionEdited, External_Partners, External_PartnersValidationFailed,External_PartnersEdited ,
        ...
        module_id, module_idValidationFailed, module_idEdited, person_id,person_idValidationFailed, person_idEdited} = this.state;
                ...
                <Dialog open={show} onClose={this.handleClose} maxWidth="xs">
                    ...
                    <DialogContent>
                        ...
                        <form className={classes.root} noValidate autoComplete="off">
                            ...
                            <TextField autoFocus type= "text" required fullWidth margin ="normal" id ="Short_Description" label="Short Description:" value = {Short_Description}
                            onChange={this.textFieldValueChange} error={Short_DescriptionValidationFailed}
                            helperText={Short_DescriptionValidationFailed ? "Short Description muss ausgefüllt werden": ""} />
                    ...
                    <DialogActions>
                        ...
                        </Button>
                        {
                            ...
                            project ?
                                <Button disabled={nameValidationFailed || Short_DescriptionValidationFailed || External_PartnersValidationFailed  ||
                                ...
                                :<Button disabled={nameValidationFailed || !nameEdited||  Short_DescriptionValidationFailed || !Short_DescriptionEdited ||External_PartnersValidationFailed  || !External_PartnersEdited ||
